...
const colors = {
  ...
  textColor1: {
    lighter: lighten(themeColors.textColor1, 0.85),
    light: lighten(themeColors.textColor1, 0.3),
    main: themeColors.textColor1,
    dark: darken(themeColors.textColor1, 0.2)
  },
  textColor2: {
    lighter: lighten(themeColors.textColor2, 0.85),
    light: lighten(themeColors.textColor2, 0.3),
    main: themeColors.textColor2,
    dark: darken(themeColors.textColor2, 0.2)
  },
  textColor3: {
    lighter: lighten(themeColors.textColor3, 0.85),
    light: lighten(themeColors.textColor3, 0.3),
    main: themeColors.textColor3,
    dark: darken(themeColors.textColor3, 0.2)
  }
};

export const PureLightTheme = createTheme({
  customColors: {
    examModalBgColor: '#FFFCF5',
    yelloButtonColor: '#FFE600',
    boxBgColor: '#FFFCF5',
    viewResultLinkColor: '#FF5B00',
    selectedMenuColor: '#F5E6AA80'
  },
  // direction: i18n.dir(),
  colors: {
    gradients: {
  ...
  palette: {
    ...
    text: {
      primary: colors.textColor1.main,
      secondary: colors.textColor2.main,
  ...
  typography: {
    fontFamily:
      '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji",Work Sans, "Biryani", "Poppins"',
    h1: {
      fontWeight: 700,
      fontSize: '40px'
    },
